(() => {
  ...
  const valid = ['home','M','MA','MB','MC','MD','MQ','MG','MI','MJ','MP','PS','PX','MAF','MBF','MCF','MDF','MGF','MIF','MJF','MF','MPF','MQF','PSF','PXF'];
...
const navSelectors = '.m-nav, .ma-nav, .mb-nav, .mc-nav, .md-nav, .mg-nav, .mi-nav, .mj-nav, .mp-nav, .me-nav, .phone__nav, .px-bottom, .f-navbar';
